      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-16">
        ...
        <div className="flex justify-center gap-6 mb-12">
          <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-5 flex flex-col items-center w-40">
            ...
            <span className="text-2xl font-bold text-gray-900 dark:text-white">457</span>
          ...
          <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-5 flex flex-col items-center w-40">
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400">Concepts</span>
          </div>
        </div>
        
        <div className="bg-white dark:bg-gray-800 shadow-lg rounded-xl overflow-hidden">
          <div className="p-6 bg-indigo-50 dark:bg-indigo-900/30 border-b border-gray-200 dark:border-gray-700">
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200">Featured Problems</h2>
            <p className="text-gray-600 dark:text-gray-400">Tackle these selected challenges to improve your skills</p>
          </div>
